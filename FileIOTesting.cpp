...
int main(){
    ...
    string someStringF = "{\"id\":4432,\"name\":\"Urdu\",\"rank\":0,\"specialization\":\"Queso Studies\",\"advisees\":[234423,543523,243465,987967]}";
    cout << someString << endl;
    Student bitchface = UnserializeS(someString);
    cout << bitchface << endl;
    cout << "**********************************" << endl;
    cout << someStringF << endl << endl << endl;
    Faculty someFaculty = UnserializeF(someStringF);
    cout << someFaculty << endl;
    return 0;
}
